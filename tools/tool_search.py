...
# their schema; once enabled they stay direct unless the deferral list names them. Includes
# the reaction toolset, folded in for a chat platform whose adapter supports reactions.
